...
import (
	...
	"gitlab.praktikum-services.ru/std-013-60/momo-store/cmd/api/app"
	"gitlab.praktikum-services.ru/std-013-60/momo-store/cmd/api/dependencies"
	"gitlab.praktikum-services.ru/std-013-60/momo-store/internal/logger"
)
