...
import (
	"gitlab.praktikum-services.ru/std-013-60/momo-store/internal/store/dumplings"
	"gitlab.praktikum-services.ru/std-013-60/momo-store/internal/store/dumplings/fake"
)
